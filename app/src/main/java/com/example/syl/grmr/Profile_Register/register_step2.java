...
public class register_step2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnman = (ImageView)findViewById(R.id.btn_man);
        btngirl = (ImageView)findViewById(R.id.btn_girl);
        textman = (TextView)findViewById(R.id.man_text);
        textgirl = (TextView)findViewById(R.id.girl_text);
        step2=(Button)findViewById(R.id.step2_btn);
        manLayout=(LinearLayout)findViewById(R.id.man_layout);
        girlLayout=(LinearLayout)findViewById(R.id.girl_layout);
