...
import com.example.dongh.grmr.Profile_Register.register_step5;
...
public class LoginActivity extends AppCompatActivity {
    ...
    private int check = 0;
    LinearLayout facebookLoginButton, kakaoLoginButton, emailLoginButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /********************************갈래말래(email) Login*************************************/
        emailLoginButton = (LinearLayout) findViewById(R.id.emailLoginButton);
        emailLoginButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                //Intent login2Intent = new Intent(LoginActivity.this, register_step1.class);
                Intent login2Intent = new Intent(LoginActivity.this, register_step5.class);
                LoginActivity.this.startActivity(login2Intent);
            }
        });

        /****************************FaceBook Login***********************************/
        facebookLoginButton = (LinearLayout) findViewById(R.id.facebookLoginButton);
